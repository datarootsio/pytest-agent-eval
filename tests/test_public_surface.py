...
ANY_ALLOWLIST = {
    ...
    "adapters/langchain.py": "duck-typed LangChain Runnable",
    "adapters/smolagents.py": "duck-typed smolagents agent",
    "adapters/pydantic_ai.py": "duck-typed pydantic-ai message parts",
}
